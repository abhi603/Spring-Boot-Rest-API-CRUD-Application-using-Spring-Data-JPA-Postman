...
public class TicketBookingController {
	...
	@DeleteMapping(value="/ticket/{ticketId}")//http://localhost:8080/api/tickets/ticket/1
	public void deleteTicket(@PathVariable("ticketId")Integer ticketId){
		ticketBookingService.deleteTicket(ticketId);
	}
	
	@PutMapping(value="/ticket/{ticketId}/{newEmail:.+}")//http://localhost:8080/api/tickets/ticket/1/abhi_new@gmail.com
